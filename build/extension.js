...
let globalStorage = {}
let DuckDuckGo = vscode.commands.registerCommand('internet-search.DuckDuckGo',async function () {
let funcName = "duckduckgo"; let pyVar = "python";
...
context.subscriptions.push(DuckDuckGo);
let Google = vscode.commands.registerCommand('internet-search.Google',async function () {
let funcName = "google"; let pyVar = "python";
let py = spawn(pyVar, [pythonPath, funcName]);
...
let Bing = vscode.commands.registerCommand('internet-search.Bing',async function () {
let funcName = "bing"; let pyVar = "python";
let py = spawn(pyVar, [pythonPath, funcName]);
...
context.subscriptions.push(Bing);
}
